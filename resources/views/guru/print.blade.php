...
<body>
    ...
    <div class="profile-section">
        <div class="photo-section">
            @if($teacher->photo)
                <img src="{{ Storage::url($teacher->photo) }}" alt="Foto {{ $teacher->full_name }}">
            @else
    ...
    <div class="details-grid">
        <div class="column-left">
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">{{ $teacher->birth_place ?? '-' }}, {{ $teacher->birth_date ? $teacher->birth_date->format('d F Y') : '-' }}</div>
            </div>
        ...
        <div class="column-right">
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">{{ $teacher->status ?? '-' }} - {{ $teacher->academic_year ?? '-' }}</div>
            </div>
