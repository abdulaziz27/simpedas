...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" id="printable-content">
    ...
    <nav class="mb-6 flex items-center text-white text-base print:hidden" aria-label="Breadcrumb">
        ...
        <a href="{{ route('public.search-non-teaching-staff') }}" class="font-semibold hover:underline">Pencarian Tenaga Pendidik Non Guru</a>
        <span class="mx-2">&gt;</span>
    ...
    <div class="bg-[#09443c] p-10 rounded-2xl shadow-lg print:bg-white print:text-black">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
                ...
                <p class="font-bold text-white text-lg mb-4 print:text-black">{{ $nonTeachingStaff->nip ?? '-' }}</p>
            ...
            <div>
                ...
                <div class="flex space-x-4 mt-2 print:hidden">
                    ...
                    <a href="{{ route('public.search-non-teaching-staff') }}" class="text-green-300 hover:text-green-400 font-semibold text-lg">
