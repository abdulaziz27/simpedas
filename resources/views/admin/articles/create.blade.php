...
<div class="min-h-screen bg-[#125047] py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center space-x-2 text-white mb-6">
            ...
            <span class="text-gray-300">&gt;</span>
            <span class="border-b-2 border-white">Buat Artikel Baru</span>
        </nav>
        ...
        <div class="bg-white rounded-xl p-8 shadow-lg">
            ...
            <form action="{{ route('dinas.articles.store') }}" method="POST" enctype="multipart/form-data" id="article-form">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="3"
                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                        placeholder="Ringkasan singkat artikel (opsional, max 500 karakter)">{{ old('excerpt') }}</textarea>
                ...
                <div class="mb-6 border-t pt-6">
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="2"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                            placeholder="Deskripsi untuk SEO (jika kosong akan menggunakan excerpt)">{{ old('meta_description') }}</textarea>
