        ...
        <div class="bg-white rounded-xl p-8 shadow-lg">
            ...
            <form action="{{ auth()->user()->hasRole('admin_sekolah') ? route('sekolah.students.store') : route('dinas.students.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="sekolah_id" id="sekolah_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                ...
                                @foreach($schools as $school)
                                    <option value="{{ $school->id }}" {{ old('sekolah_id') == $school->id ? 'selected' : '' }}>{{ $school->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="nisn" id="nisn" value="{{ old('nisn') }}" required maxlength="20" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="nipd" id="nipd" value="{{ old('nipd') }}" maxlength="20" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap') }}" required maxlength="150" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir') }}" required maxlength="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="rombel" id="rombel" value="{{ old('rombel') }}" required maxlength="50" placeholder="Contoh: 6A, 9B, 12 IPA 1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <select name="status_siswa" id="status_siswa" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                ...
                                <option value="tamat" {{ old('status_siswa') == 'tamat' ? 'selected' : '' }}>Tamat</option>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('alamat') }}</textarea>
                            @error('alamat') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="kelurahan" class="block text-sm font-medium text-gray-700">Kelurahan</label>
                            <input type="text" name="kelurahan" id="kelurahan" value="{{ old('kelurahan') }}" maxlength="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                            @error('kelurahan') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="kecamatan" class="block text-sm font-medium text-gray-700">Kecamatan</label>
                            <input type="text" name="kecamatan" id="kecamatan" value="{{ old('kecamatan') }}" maxlength="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                            @error('kecamatan') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="kode_pos" class="block text-sm font-medium text-gray-700">Kode Pos</label>
                            <input type="text" name="kode_pos" id="kode_pos" value="{{ old('kode_pos') }}" maxlength="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="text" name="nama_ayah" id="nama_ayah" value="{{ old('nama_ayah') }}" maxlength="150" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}" maxlength="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_ibu" id="nama_ibu" value="{{ old('nama_ibu') }}" maxlength="150" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}" maxlength="100" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="anak_ke" id="anak_ke" value="{{ old('anak_ke') }}" min="1" max="20" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="jumlah_saudara" id="jumlah_saudara" value="{{ old('jumlah_saudara') }}" min="0" max="20" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp') }}" maxlength="20" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <select name="kip" id="kip" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                                <option value="">Pilih</option>
                                <option value="1" {{ old('kip') == '1' ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ old('kip') == '0' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="transportasi" id="transportasi" value="{{ old('transportasi') }}" maxlength="50" placeholder="Contoh: Sepeda, Motor, Jalan Kaki" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="jarak_rumah_sekolah" id="jarak_rumah_sekolah" value="{{ old('jarak_rumah_sekolah') }}" step="0.01" min="0" max="999.99" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="number" name="tinggi_badan" id="tinggi_badan" value="{{ old('tinggi_badan') }}" min="50" max="250" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <input type="number" name="berat_badan" id="berat_badan" value="{{ old('berat_badan') }}" min="10" max="200" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ auth()->user()->hasRole('admin_sekolah') ? route('sekolah.students.index') : route('dinas.students.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition">
                        Batal
                    </a>
