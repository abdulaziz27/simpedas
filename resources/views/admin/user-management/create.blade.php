    ...
    <div class="min-h-screen bg-[#125047] py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center space-x-2 text-white mb-6">
                ...
                <span class="text-gray-300">&gt;</span>
                <span class="border-b-2 border-white">Tambah Pengguna</span>
            </nav>

            {{-- Form Card --}}
            <div class="bg-white rounded-xl p-8 shadow-lg">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Form Tambah Pengguna Baru</h1>
                ...
                <form action="{{ auth()->user()->hasRole('admin_sekolah') ? route('sekolah.user-management.store') : route('dinas.user-management.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 pr-10">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="password_confirmation" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 pr-10">
