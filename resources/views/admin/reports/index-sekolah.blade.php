...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-[#136e67] rounded-2xl shadow-lg px-8 py-5 mb-8 border-b-4 border-white flex items-center">
        <h2 class="text-3xl font-bold text-white mx-auto">Dashboard Laporan Admin Sekolah</h2>
    </div>

    {{-- Reports Grid --}}
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {{-- Laporan Siswa --}}
        <a href="{{ route('sekolah.reports.students') }}" class="bg-[#0E453F] hover:bg-[#0a403a] text-white rounded-xl shadow-xl p-6 flex flex-col items-center justify-center transition group border-2 border-transparent hover:border-blue-400 hover:shadow-blue-400/50">
            <div class="mb-4">
            ...
            <p class="text-sm text-gray-300 text-center mt-2">Data siswa sekolah</p>
        </a>

        {{-- Laporan Guru --}}
        <a href="{{ route('sekolah.reports.teachers') }}" class="bg-[#0E453F] hover:bg-[#0a403a] text-white rounded-xl shadow-xl p-6 flex flex-col items-center justify-center transition group border-2 border-transparent hover:border-blue-400 hover:shadow-blue-400/50">
            <div class="mb-4">
                <svg class="h-16 w-16 text-green-300 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-sm text-gray-300 text-center mt-2">Data guru sekolah</p>
        </a>
