    ...
    <div class="min-h-screen bg-[#125047] py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex items-center space-x-2 text-white mb-6">
                ...
                <span class="text-gray-300">&gt;</span>
                <span class="border-b-2 border-white">Tambah Foto</span>
            </nav>

            {{-- Form Card --}}
            <div class="bg-white rounded-xl shadow-lg p-8">
                <h2 class="text-3xl font-bold text-[#125047] mb-6">Tambah Foto ke Galeri</h2>

                <form action="{{ route('dinas.galleries.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('description') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category') }}" placeholder="Contoh: Kegiatan, Acara, Prestasi"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
