            ...
            <form action="{{ auth()->user()->hasRole('admin_sekolah') ? route('sekolah.teachers.update', $teacher) : route('dinas.teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" id="address" rows="3" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">{{ old('address', $teacher->address) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="rank" id="rank" value="{{ old('rank', $teacher->rank) }}" placeholder="Contoh: III/c" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="position" id="position" value="{{ old('position', $teacher->position) }}" placeholder="Contoh: Guru Kelas, Wakepsek" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="subjects" id="subjects" value="{{ old('subjects', $teacher->subjects) }}" placeholder="Contoh: Matematika, Fisika" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="education_level" id="education_level" value="{{ old('education_level', $teacher->education_level) }}" placeholder="Contoh: S1 Pendidikan Matematika" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                            ...
                            <option value="Pensiun" {{ old('status', $teacher->status) == 'Pensiun' ? 'selected' : '' }}>Pensiun</option>
                        </select>
