...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Setting::set('contact_phone', '', 'text', 'Telepon', 'Nomor telepon Dinas Pendidikan');
        Setting::set('contact_email', '', 'text', 'Email', 'Alamat email Dinas Pendidikan');
        Setting::set('contact_hours', 'Senin - Jumat: 08:00 - 16:00 WIB', 'textarea', 'Jam Operasional', 'Jam operasional Dinas Pendidikan');
